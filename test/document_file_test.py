...
class DocumentFileTest(unittest.TestCase):
    ...
    def test_calculate_hash(self):
        document = DocumentFile.from_path('test_doc_source_name', 'documents', 'documents/ducks.pdf')
    ...
    def test_from_path(self):
        document = DocumentFile.from_path('test_doc_source_name', 'documents', 'documents/frogs.md')
