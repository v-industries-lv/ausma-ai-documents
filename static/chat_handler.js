...
function message_as_html(msg) {
  ...
  if (msg.role === "user") {
    ...
    entry.innerHTML =
      "<img src='/static/svg-icons/square-bubble-user-svgrepo-com.svg' class=\"user-icon\" style='height:23px;width:23px;margin-right:10px;vertical-align:middle;'>" +
    ...
    entry.innerHTML =
      "<img src='/static/svg-icons/ausma.ai_simple_logo_final_006.svg' class=\"user-icon\" style='height:23px;width:23px;margin-right:10px;vertical-align:middle;'>" +
      "<span><span class='assistant'>ausma.ai:</span><div class='message'>" +
      msg.content +
      "</div></span>" +
      '<a href="/download_message/' +
      msg.id +
      '" target="_blank" rel="noopener" download>' +
      "<img src='/static/svg-icons/align-bottom-svgrepo-com.svg' class=\"assistant-utils-download\" style='height:20px;width:20px;margin-right:5px;vertical-align:middle;'>" +
      "</a>" +
      '<a href="/download_rag_sources/' +
      msg.id +
      '" target="_blank" rel="noopener" download>' +
      "<img src='/static/svg-icons/copy-svgrepo-com.svg' class=\"assistant-utils-download\" style='height:20px;width:20px;margin-right:5px;vertical-align:middle;'>" +
      "</a>" +
...
socket.on("progress", function (data) {
  ...
  if (isNaN(tokens_per_s_formatted)) {
      var msg = "Processing... Tokens so far: " + tokens;
  } else {
      var msg =
    "Processing... " +
